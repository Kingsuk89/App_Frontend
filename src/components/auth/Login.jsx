			...
			{isPending ? (
				...
				<div className='h-screen w-screen flex items-center justify-center'>
					<div className='dark:bg-transparent bg-[#F4CE14] border border-[rgba(255,255,255,.2)] backdrop-blur-lg  w-[300px] h-[500px] md:w-[400px] rounded-lg m-20'>
						<h2 className='text-center pt-6 text-white text-2xl font-bold'>Login</h2>
						<h4 className='text-center pt-2 text-white text-md '>Welcome back!</h4>
						<form
							...
							<div>
								<div className='mb-4 gap-2'>
									...
									<input
										...
										{...register('email')}
									/>
									{errors.email && <p className='text-rose-700 pt-2'>{errors.email?.message}</p>}
								</div>
								<div className='mb-6'>
									...
									/>
									{errors.password && (
										<p className='text-rose-700 pt-2'>{errors.password?.message}</p>
									)}
								</div>
							</div>
